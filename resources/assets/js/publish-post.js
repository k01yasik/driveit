$().ready(function () {
    $('.publish').click(function (e) {
        ...
        let data = 'id=' + id;
        let publish = "<svg version='1.1' id='publish' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 26 26' xmlns:xlink='http://www.w3.org/1999/xlink' enable-background='new 0 0 26 26'>" +
        ...
        let unpublish = "<svg version='1.1' id='unpublish' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 15.381 15.381' " +
        ...
        $.ajax({
            ...
            if (e.currentTarget.firstElementChild.id === 'unpublish') {
