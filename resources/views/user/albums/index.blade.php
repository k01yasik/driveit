                    ...
                    @foreach($user['albums'] as $album)
                        <div class="album-wrapper">
                            <div class="album-caption">
                                <a href="{{ route('user.albums.show', ['username' => $user['username'], 'albumname' => $album['name']]) }}" class="album-caption-link">{{ mb_strtoupper(mb_substr($album['name'], 0, 1)) . mb_substr($album['name'], 1) }}</a>
