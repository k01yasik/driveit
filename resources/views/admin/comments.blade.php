                ...
                @if ($comments->hasPages())
                    <div class="pagination-wrapper">
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ config('app.url').'/admin/comments/page/'. $previousNumberPage }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                                </li>
                            @endif
                            @for ($i = 1; $i <= $lastNumberPage; $i++)
                                ...
                                @else
                                    @if ($i == 1)
                                        <li class="page-item"><a class="page-link" href="{{ config('app.url').'/admin/comments' }}">{{ $i }}</a></li>
                                    @else
                                        <li class="page-item"><a class="page-link" href="{{ config('app.url').'/admin/comments/page/'.$i }}">{{ $i }}</a></li>
                                    @endif
                                @endif
                            @endfor
                            ...
                            @if ($comments->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ config('app.url').'/admin/comments/page/'. $nextNumberPage }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                                </li>
                            @else
