            ...
            @foreach($users as $u)
                <div class="user-block">
                    <div class="user-block-avatar">
                        <a href="{{ route('user.profile', ['username' => $u->username]) }}" class="user-block-avatar-link">
                            <img src="{{ $u->profile->avatar }}" class="user-block-avatar-img" />
                        </a>
                        <a href="{{ route('user.profile', ['username' => $u->username]) }}" class="user-block-username-link">{{ $u->username }}</a>
                    </div>
                    @if ($u->rip)
                        <div class="user-block-ban-button right">
                    ...
                    @else
                        <a href="{{ route('admin.user.delete', ['username' => $u->username]) }}" class="user-block-delete-button right">
                    ...
                    @endif
                    <a href="{{ route('admin.user.show', ['username' => $u->username]) }}" class="user-block-show-button right margin-right-1">
                    ...
                    @if ( $u->email_verified_at)
                        <div class="user-block-checked-button right margin-right-1">
