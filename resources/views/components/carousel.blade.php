                ...
                <li>
                    <a href="{{ route('category.show', ['category' => 'auto']) }}">
                        <picture>
                            ...
                            <img src="{{asset('storage/Bzdykin/carousel/bmw-m6.webp')}}" width="1200" height="400" alt="Раздел авто" />
                        </picture>
                    </a>
                ...
                <li>
                    <a href="{{ route('category.show', ['category' => 'moto']) }}">
                        <picture>
                            ...
                            <img src="{{asset('storage/Bzdykin/carousel/moto.webp')}}" width="1200" height="400" alt="Раздел мото" />
                        </picture>
                    </a>
                ...
                <li>
                    <a href="{{ route('category.show', ['category' => 'law']) }}">
                        <picture>
                            ...
                            <img src="{{asset('storage/Bzdykin/carousel/law.webp')}}" width="1200" height="400" alt="Раздел право"/>
                        </picture>
                    </a>
                ...
                <li>
                    <a href="{{ route('category.show', ['category' => 'helpful']) }}">
                        <picture>
                            ...
                            <img src="{{asset('storage/Bzdykin/carousel/helpful.webp')}}" width="1200" height="400" alt="Раздел полезное"/>
                        </picture>
                    </a>
