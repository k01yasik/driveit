<div class="sitetop">
    <div class="container">
        <div class="row">
            <div class="col s12 m4 l3 v-h-3 flex flex-h-center-small">
                <div class="logo"><a href="{{url('/')}}">web-rookie.<span>ru</span></a></div>
            </div>
            <div class="col s12 m3 l2 v-h-3 flex flex-v-center flex-h-center-small flex-j-end-m">
            <ul class="social-button">
                <li><a href="https://vk.com/driveitwithme" target="_blank" rel="noopener noreferrer nofollow">
                        <svg version="1.1" class="svg-vk" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 14.171 14.171" style="enable-background:new 0 0 14.171 14.171;" xml:space="preserve">
                        <g>
            ...
            <div class="col s12 m5 l4 v-h-3 flex flex-v-center flex-h-center-small col-last-m">
                <div class="search">
            ...
            <div class="col s12 m6 offset-m3 l3 v-h-3 flex flex-v-center flex-h-center-small flex-j-end-l">
