...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_social_likes_next__ = __webpack_require__(19);
...
$().ready(function () {
    ...
    var storage = localStorage.getItem('title-post-image-url');

    if (storage) {
        var image_element = "<img src=" + storage + " class='uploaded-image' />";
    ...
    $('#post_upload_image_input').change(function () {
        ...
        if (url !== '') {
            ...
            $.ajax({
                ...
                var selectedFile = $('#post_upload_image_input')[0].files[0];
                ...
                if (selectedFile) {
                    ...
                    $.ajax({
                        ...
                        var image_element = "<img src=" + result + " class='uploaded-image' />";
...
$().ready(function () {
    ...
    var editor = $('.text-editor-body');

    var headingSub = $('.select-heading-sub');
    var selectItemSub = $('.select-item-sub');
    var imageSelectItemSub = $('.image-select-item-sub');
    var selectItemInput = $('.select-item-input');
    var imageSelectItemInput = $('.image-select-item-input');
    var imageItem = $('.image-item');
    var upload_image = $('#upload_image_form_input');
    ...
    $('.heading_2').click(function () {
        var element = $('.select-heading-input');
    ...
    $('.image-checked-item').click(function (e) {
        e.stopImmediatePropagation();
        var input = imageSelectItemInput.val();
        imageSelectItemInput.val('');

        if (input) {
            var images = $('.text-editor-body img');
    ...
    upload_image.change(function () {
        var selectedFile = upload_image[0].files[0];
...
$().ready(function () {
    $('.publish').click(function (e) {
        ...
        var data = 'id=' + id;
        var publish = "<svg version='1.1' class='publish-svg' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 26 26' xmlns:xlink='http://www.w3.org/1999/xlink' enable-background='new 0 0 26 26'>" + "<path d='m.3,14c-0.2-0.2-0.3-0.5-0.3-0.7s0.1-0.5 0.3-0.7l1.4-1.4c0.4-0.4 1-0.4 1.4,0l.1,.1 5.5,5.9c0.2,0.2 0.5,0.2 0.7,0l13.4-13.9h0.1v-8.88178e-16c0.4-0.4 1-0.4 1.4,0l1.4,1.4c0.4,0.4 " + "0.4,1 0,1.4l0,0-16,16.6c-0.2,0.2-0.4,0.3-0.7,0.3-0.3,0-0.5-0.1-0.7-0.3l-7.8-8.4-.2-.3z'></path></svg>";

        var unpublish = "<svg version='1.1' class='unpublish-svg' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 15.381 15.381' " + "style='enable-background:new 0 0 15.381 15.381;' xml:space='preserve'><g><g>" + "<path d='M12.016,15.381h-8.65c-1.558,0-2.826-1.268-2.826-2.825v-9.73C0.54,1.268,1.808,0,3.366,0h8.65 c1.558,0,2.825,1.268,2.825,2.826v9.73C14.841,14.114,13.574,15.381,12.016,15.381z " + "M3.366,1.305 c-0.839,0-1.521,0.683-1.521,1.521v9.73c0,0.838,0.683,1.521,1.521,1.521h8.65c0.839,0,1.521-0.684,1.521-1.521v-9.73 c0-0.839-0.683-1.521-1.521-1.521C12.016,1.305,3.366,1.305,3.366,1.305z'>" + "</path></g></g></svg>";
        ...
        $.ajax({
            ...
            if (e.currentTarget.firstElementChild.className.baseVal === 'unpublish-svg') {
                e.currentTarget.innerHTML = publish;
            } else {
                e.currentTarget.innerHTML = unpublish;
            }
        });
    });
});
...
$().ready(function () {
    ...
    var smallFirstLevel = $('.small-first-level');
...
$().ready(function () {
    var wrapper = $('.add-comment-wrapper');
    var target_element = void 0;

    $('.add-comment-button').click(function () {
        var text_editor = $('.text-editor-body');
        /*text_editor.focus();
        document.execCommand('selectAll', false, null);
        document.execCommand('removeFormat', false, null);*/
        var post = wrapper.data('post');
        var level = wrapper.data('level');
        var parent = wrapper.data('parent');
        var message = text_editor.html();
        ...
        $.ajax({
            ...
            var comment_html = "<div class='comment-item level-" + result.level + "' data-level='" + result.level + "'>" + "<div class='header'>" + "<a href='" + result.url + "' class='user-avatar-link header-item'>" + "<img src='" + result.avatar + "' class='user-avatar' alt='" + result.username + "' />" + "</a>" + "<a href='" + result.url + "' class='post-author header-item'>" + result.username + "</a>" + "<div class='right'>" + result.created_at + "</div>" + "</div>" + "<div class='body'>" + "<p>" + result.message + "</p>" + "</div></div>";
    ...
    $('.reply-button').click(function () {
        var reply = $(this);
        var level = reply.data('level');
        level += 1;

        var parent = reply.data('parent');
        ...
        var clicked_parent = $(this).parents('.comment-item');
        var clicked_parent_level = clicked_parent.data('level');
...
var _socialLikes = __webpack_require__(20);
...
var _facebook = __webpack_require__(23);
...
var _odnoklassniki = __webpack_require__(24);
...
var _pinterest = __webpack_require__(25);
...
var _plusone = __webpack_require__(26);
...
var _vkontakte = __webpack_require__(28);
...
var _telegram = __webpack_require__(29);
...
var _linkedin = __webpack_require__(30);
